    ...
    <div className={`h-full flex flex-col border-r border-ops-border/40 bg-ops-panel/50 backdrop-blur-sm transition-[width] duration-300 ease-in-out ${collapsed ? 'w-[72px]' : 'w-[300px]'}`}>
      <div className={`relative flex items-center border-b border-ops-border/30 px-4 py-4 ${collapsed ? 'justify-center' : 'justify-between'}`}>
        {collapsed ? (
          ...
          <>
            <div>
              <h2 className="text-[12px] font-bold  tracking-[0.15em] text-ops-cyan/90">Nodes & Sessions</h2>
            </div>
            <div className="flex items-center gap-2">
              <button type="button" className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-ops-border/50 bg-ops-deep/50 text-ops-muted transition-all duration-200 hover:border-ops-cyan/50 hover:text-ops-cyan active:scale-90" aria-label="Collapse Navigation Drawer" onClick={onToggleCollapse}>
              ...
              <button type="button" className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-ops-border/50 bg-ops-deep/50 text-ops-muted transition-all duration-200 hover:border-ops-cyan/50 hover:text-ops-cyan active:scale-90" aria-label="Add Node Connection" onClick={onAddAsset}>
